function setPlaceholders(){$("[data-placeholder2]").each((function(t,a){let e=$(a).attr("data-placeholder"),i=$(a).attr("data-placeholder2");window.innerWidth>576?$(a).attr("placeholder",e):$(a).attr("placeholder",i)}))}setPlaceholders(),$("._tab").click((function(){let t=$(this).parents("._tabs-parent"),a=$(this).attr("data-tab");console.log(t),$(t).find("._tab").removeClass("_active"),$(this).addClass("_active"),$(t).find(".tab-content").removeClass("_active"),$(t).find("."+a).addClass("_active")})),$(document).on("click",".qa-card__show",(function(t){$(this).parents(".qa-card").toggleClass("_active"),$(this).siblings(".qa-card__hidden").slideToggle()})),$(".footer-nav__top").click((function(){window.innerWidth<=576&&($(this).parents(".footer-nav").toggleClass("_active"),$(this).siblings(".footer-nav__bottom").slideToggle())}));
...
let filterSliders=document.querySelectorAll(".filter-slider");filterSliders.forEach(e=>{const t=e.querySelector(".range-slider"),r=[e.querySelector(".range-slider__input1"),e.querySelector(".range-slider__input2")];let l=+e.getAttribute("data-start"),a=+e.getAttribute("data-start2"),i=+e.getAttribute("data-min"),n=+e.getAttribute("data-max");t&&noUiSlider.create(t,{start:[l,a],connect:!0,step:1,range:{min:i,max:n}}),t&&(t.noUiSlider.on("update",(function(e,t){r[t].value=Math.round(e[t])})),r.forEach((e,t)=>{e.addEventListener("change",e=>{o(t,e.currentTarget.value)})}));const o=(e,r)=>{let l=[null,null];l[e]=r,t.noUiSlider.set(l)}}),$(".more-checkbox").click((function(){$(this).parents(".filter-group__checks").addClass("_show-all")})),$("._toggle-filter").click((function(){$(".filter").toggleClass("_open"),$(".m-page").toggleClass("fixed-body")}));
...
$(".file-input input").change((function(){let e=$(this).parents(".file-input"),t=$(this);if("undefined"!=typeof FileReader){let t=$(e).find(".file-input__upload");$($(this)[0].files).each((function(i){let l=$(this),n=new FileReader;n.onload=function(l){let n=`\n                    <div class="upload-file">\n                        <div class="upload-file__img">\n                            <img src="${l.target.result}" alt="">\n                        </div>\n                        <button type="button" data-id="${i}" class="upload-file__remove">\n                            <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">\n                                <circle cx="6.5" cy="6.5" r="6.5" fill="#FF6915"/>\n                                <path d="M4 9L8.99967 4M9 9L4.00033 4" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>\n                            </svg>\n                        </button>\n                    </div>\n                    `;t.append(n),$(e).addClass("_uploaded")},n.readAsDataURL(l[0])}))}else alert("This browser does not support HTML5 FileReader.");$(document).on("click",".upload-file__remove",(function(i){let l=+$(this).attr("data-id");$(this).parents(".upload-file").remove();let n=new DataTransfer;for(let e=0;e<$(t).get(0).files.length;e++)console.log(e),l!==e&&n.items.add($(t).get(0).files[e]);$(t)[0].files=n.files,console.log($(t)[0].files.length),$(e).find(".upload-file__remove").each((function(e,t){console.log(e),$(t).attr("data-id",e)}))}))}));
...
function fix100vh(){let e=.01*window.innerHeight;document.documentElement.style.setProperty("--vh",e+"px")}window.addEventListener("DOMContentLoaded",()=>{$(".fg select").niceSelect(),fix100vh(),window.addEventListener("resize",()=>{fix100vh(),getScrollBarSize(),setPlaceholders()}),getScrollBarSize()});
