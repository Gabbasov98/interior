...
$(".file-input input").change((function(){let e=$(this).parents(".file-input"),i=$(this);if("undefined"!=typeof FileReader){let i=$(e).find(".file-input__upload");$($(this)[0].files).each((function(t){let n=$(this),l=new FileReader;l.onload=function(n){let l=`\n                    <div class="upload-file">\n                        <div class="upload-file__img">\n                            <img src="${n.target.result}" alt="">\n                        </div>\n                        <button type="button" data-id="${t}" class="upload-file__remove">\n                            <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">\n                                <circle cx="6.5" cy="6.5" r="6.5" fill="#FF6915"/>\n                                <path d="M4 9L8.99967 4M9 9L4.00033 4" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>\n                            </svg>\n                        </button>\n                    </div>\n                    `;i.append(l),$(e).addClass("_uploaded")},l.readAsDataURL(n[0])}))}else alert("This browser does not support HTML5 FileReader.");$(document).on("click",".upload-file__remove",(function(t){let n=+$(this).attr("data-id");$(this).parents(".upload-file").remove();let l=new DataTransfer;for(let e=0;e<$(i).get(0).files.length;e++)console.log(e),n!==e&&l.items.add($(i).get(0).files[e]);$(i)[0].files=l.files,console.log($(i)[0].files.length),$(e).find(".upload-file__remove").each((function(e,i){console.log(e),$(i).attr("data-id",e)}))}))})),$(".file-input2 input").change((function(){let e=$(this)[0].files[0];e&&$(this).siblings(".file-input2__inner").html(e.name)}));
...
function formatNums(t){let a=+$(t).attr("data-num");$(t).html(a.toLocaleString())}$(".cart-row").each((function(t,a){let m=$(a).find(".cart-row__count input"),n=$(a).find("._price"),r=$(a).find("._weight"),u=$(a).find("._price-sum"),f=$(a).find("._weight-sum");formatNums(n),formatNums(r),formatNums(u),formatNums(f),$(m).change((function(){let t=$(this).val(),a=+$(n).attr("data-num")*t,m=+$(r).attr("data-num")*t;$(u).attr("data-num",a),$(f).attr("data-num",m),formatNums(u),formatNums(f)}))}));
